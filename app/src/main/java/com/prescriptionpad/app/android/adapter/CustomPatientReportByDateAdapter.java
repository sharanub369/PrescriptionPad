 ...
 */
public class CustomPatientReportByDateAdapter extends RecyclerView.Adapter<CustomPatientReportByDateAdapter.SearchResultByDateItemViewHolder> {
    ...
    public CustomPatientReportByDateAdapter(Context context, Activity activity, List patientList) {
